...
-- ============================================
-- DONNÉES DE TEST (optionnel - décommentez pour ajouter)
-- ============================================
/*
...
-- 2. Allez sur votre dashboard Supabase
-- 3. Cliquez sur "SQL Editor" dans le menu de gauche
-- 4. Créez une nouvelle query
-- 5. Collez le SQL ci-dessus
-- 6. Décommentez la section DONNÉES DE TEST si vous voulez des données d'exemple
